...
$sql   = "SELECT * FROM server_list where server_sr=1";
$query = $db->query($sql);
$num   = $query->num_rows;
...
<center><img src="iitp.png" height="50" width="50"></center>
<center><h1> Ph.D Registration Admin  </h1>
<center><img src="student_icon.png" height="50" width="50"></center>
...
?>
<input type="radio" name="selected_server" VALUE="<?php  echo $domain_ip; ?>" checked><b><?php  echo $server_name; ?>
<?php 
 } 
?>
</TD>
...
<tr>
<td class="big" align=right>Webmail ID (without @iitp.ac.in)</td>
<td> &nbsp; &nbsp;</td>
<td><INPUT type="text" name="user_login" size=40  maxlength=40></td>
</tr>
<tr>
<td class="big" align=right>Password</td>
<td> &nbsp; &nbsp;</td>
<td><INPUT type="password" name="user_password" size=40  maxlength=40></td>
</tr>
